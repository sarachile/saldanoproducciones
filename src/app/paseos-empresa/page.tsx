        ...
        <div className="container mx-auto px-4">
             <h2 className="text-3xl md:text-4xl font-headline font-bold text-primary mb-6">
              ...
              <p className="max-w-3xl mx-auto text-lg text-foreground/90 mb-6 text-balance">
                Nuestro centro de eventos está equipado con todo lo necesario para que tu paseo de empresa sea un éxito. Disfruta de amplias áreas verdes, piscina y salones en un ambiente privado ideal para el networking y la camaradería.
              </p>
