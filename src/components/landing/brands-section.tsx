...
export default function BrandsSection() {
  ...
  return (
    <section ref={ref} id="nuestras-marcas" className="py-16 md:py-24 bg-card space-y-24">
      ...
      <div className={`container mx-auto px-4 transition-all duration-1000 ease-out delay-300 ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-8'}`}>
